# Example 3 - Lock the Computer

This example code will lock the computer using the shortcut command (Window + L) and also blink the RGB LED.

code.py - This is the example code, just copy and paste the code to Thonny and run the code.
